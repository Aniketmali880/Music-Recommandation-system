...
lottie_url = "https://assets8.lottiefiles.com/private_files/lf30_1TcivY.json"
lottie_json = load_lottieurl(lottie_url)

lottie_url2 = "https://assets5.lottiefiles.com/packages/lf20_wcfkpodg.json"
...
st_lottie(lottie_json,height=200,width=600)
...
if st.button('Recommend'):
    ...
    with col1:
            st.image('https://static.vecteezy.com/system/resources/previews/000/067/787/original/music-icon-vector.jpg',width=100)
